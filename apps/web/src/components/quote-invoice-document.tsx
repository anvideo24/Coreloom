    ...
    <article className="quote-document quote-document-invoice">
      ...
      <section className="quote-invoice-summary">
        ...
        <div className="quote-totals">
          <p>
            <span>공급가액</span>
            <strong>{won(subtotalAmount)}</strong>
          </p>
          <p>
            <span>부가세</span>
            <strong>{won(vatAmount)}</strong>
          </p>
      ...
      <footer className="quote-invoice-footer">
        <div>
          ...
          <dl className="quote-invoice-footer-list">
            <div>
              <dt>은행</dt>
              <dd>{dash(quoteIssuerProfile.bankName)}</dd>
            </div>
            <div>
              <dt>계좌</dt>
              <dd>{dash(quoteIssuerProfile.bankAccount)}</dd>
            </div>
            <div>
              <dt>예금주</dt>
              <dd>{dash(quoteIssuerProfile.accountHolder)}</dd>
            </div>
            <div>
              <dt>SWIFT</dt>
              <dd>{dash(quoteIssuerProfile.swift)}</dd>
            </div>
          </dl>
        </div>
        <div>
          ...
          <dl className="quote-invoice-footer-list">
            <div>
              <dt>사업자등록번호</dt>
              <dd>{dash(quoteIssuerProfile.businessRegistrationNumber)}</dd>
            </div>
            <div>
              <dt>이메일</dt>
              <dd>{dash(quoteIssuerProfile.email)}</dd>
            </div>
          </dl>
