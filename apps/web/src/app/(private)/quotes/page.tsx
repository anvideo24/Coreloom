...
export default async function QuotesPage() {
  ...
  return <main className="operations-shell">
    <header className="operations-header"><div><p className="auth-eyebrow">CORELOOM / QUOTES</p><h1>견적서</h1><p>견적 수정은 새 버전으로 남습니다. 금액은 부가세 별도 기준이며, 각 버전에서 인쇄 또는 PDF 저장할 수 있습니다.</p></div><a className="text-link" href="/dashboard">대시보드</a></header>
